...
<body class="dice-game-body">
        ...
        <section class="game-overlay dice-overlay">
            <div class="game-overlay-body dice-area">
                <aside class="dice-control-panel">
                    ...
                    <button class="dice-primary-btn" id="rollBtn" type="button">Bet</button>
    ...
    <script src="../assets/js/dice.js" data-balance="<?php echo number_format($balance, 2, '.', ''); ?>" data-total-wagered="<?php echo number_format($total_wagered, 2, '.', ''); ?>"></script>
</body>
</html>
